...
public class PcrCommand {
    ...
    public static PcrCommand ofOvershotTemperature() {
        float positiveOvershotTime=5;
        float positiveOvershotTemp=4;

        float negativeOvershotTime=5;
        float negativeOvershotTemp=4;
        int command=0x13;
        int length=18;
        int type=0x08;
    ...
    public static PcrCommand ofGainMode(int gain_mode){
        ...
        PcrCommand cmd=new PcrCommand();
        cmd.addCommand(TxData);

        return cmd;

    }
    public static PcrCommand ofIntergrationTime(float InTime){
        int command=0x1;
        int length=0x05;
        int type=0x20;
        List<Byte> bytes = newListWithHeader();
