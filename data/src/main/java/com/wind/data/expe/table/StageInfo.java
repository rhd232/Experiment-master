...
public abstract class StageInfo  implements StageInfoModel {
    ...
    public static final Factory<StageInfo> FACTORY=new Factory<>(new Creator<StageInfo>() {
        ...
        public StageInfo create(long _id, @Nullable Long type,
                                ...
                                @Nullable Long part_takepic, @Nullable Long cycling_id, Long during,
                                long expe_id, @Nullable Double temperature) {
            return new AutoValue_StageInfo(_id,type,startScale,curScale,stepName,
                    serialNumber,cycling_count,part_takepic,
                    cycling_id,during,expe_id,temperature);
        }
