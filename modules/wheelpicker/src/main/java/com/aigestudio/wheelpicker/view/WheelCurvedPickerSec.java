...
public class WheelCurvedPickerSec extends WheelCrossSecPicker {
    ...
    public WheelCurvedPickerSec(Context context) {
        super(context);
    }

    public WheelCurvedPickerSec(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
