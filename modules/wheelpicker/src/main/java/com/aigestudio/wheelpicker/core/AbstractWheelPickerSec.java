 ...
 */
public abstract class AbstractWheelPickerSec extends View implements IWheelPickerSec {
    ...
    public AbstractWheelPickerSec(Context context) {
        super(context);
        init(null);
    }

    public AbstractWheelPickerSec(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }
