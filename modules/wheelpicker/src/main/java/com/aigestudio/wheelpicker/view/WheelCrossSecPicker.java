 ...
 */
public abstract class WheelCrossSecPicker extends AbstractWheelPickerSec
    ...
    public WheelCrossSecPicker(Context context) {
        super(context);
    }

    public WheelCrossSecPicker(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
